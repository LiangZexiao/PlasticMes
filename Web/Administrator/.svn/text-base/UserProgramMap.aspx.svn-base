<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserProgramMap.aspx.cs" Inherits="Administrator_UserProgramMap" %>


<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>个人权限控制(UserProgramMap)</title>
...
<body>
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="section-content">
          ...
          <tr>
            <td style="height: 24px">当前位置:系统管理 -> 个人权限控制</td>
          </tr>
          </table>
<br />
                    ...
                    <table class="itemtable" cellspacing="1" cellpadding="2" border="0">
                      <tr>
                        ...
                        <Columns>
                                ...
                                <asp:ButtonField CommandName="select" DataTextField="ProgramName" HeaderText="模块代号" />
                            ...
                            <asp:BoundField DataField="ChkFlag" HeaderText="审核" />
                            <asp:BoundField DataField="aDate" HeaderText="创建时间" Visible="false" />
...
<table class="itemtable" cellspacing="1" cellpadding="2" border="0">
                      ...
                      <td>
                        ...
                        <asp:TextBox ID="txtID" runat="server" Visible="False" CssClass="textbox" Width="20px"></asp:TextBox></td>
                      </tr>
                    </table>
                <br />
                 <table class="itemtable" cellspacing="1" cellpadding="2" border="0">
 ...
 <table border="0" style="border-collapse: collapse;" width="100%" cellpadding="1" cellspacing="1" class="texttable">
                                        <tr>
                                            <th align="right" class="label">
                                                <asp:Label ID="Label2" runat="server" CssClass="txtlab" Text="帐号:"></asp:Label></th>                                                
                                            <td><asp:DropDownList ID="ddlUserID" runat="server" CssClass="textboxodl" AutoPostBack="True" OnSelectedIndexChanged="ddlUserID_SelectedIndexChanged">
                                            </asp:DropDownList>
                                                <asp:Label ID="Label1" runat="server" ForeColor="Red"></asp:Label></td>
                                            <th align="right" class="label">
                                                <asp:Label ID="Label3" runat="server" CssClass="txtlab" Text="模块名称:"></asp:Label></th>                                                
                                            <td><asp:DropDownList ID="ddlProgramID" runat="server" CssClass="textboxodl">
                                            </asp:DropDownList></td>
                                        </tr>
                                        <tr>
                                            <th align="right">
                                        ...
                                        <tr>
                                            ...
                                            <th align="right">
                                                审核通过:</th>
                                            <td><asp:DropDownList ID="ddlChkFlag" runat="server" CssClass="dropdownlist">
                                                <asp:ListItem Value="0">否</asp:ListItem>
                                                <asp:ListItem Value="1">是</asp:ListItem>
                                            </asp:DropDownList></td>
                                        </tr>
