<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MachineMstr.aspx.cs" 
Inherits="Monitor_MachineMstr" ValidateRequest="false" %>

<%@ Register Assembly="System.Web.Extensions, Version=1.0.61025.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35"
    Namespace="System.Web.UI" TagPrefix="asp" %>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
<meta http-equiv="Refresh" content="300" runat="server" id="RefreshMachienMstr" />
    <title>注塑机器监视</title>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table style="width: 100%" class="itemtable" cellspacing="1" cellpadding="2" border="0">
                <tr>
                    <th valign="middle">
                        车间编号:<asp:DropDownList ID="ddlMachine_SeatCode" runat="server" AutoPostBack="True"
                        ...
                        机器状态:<asp:DropDownList ID="ddlMachineSate" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DorpDownList_SelectedIndexChanged">
                            ...
                            <asp:ListItem Value="Yellow">异常生产</asp:ListItem>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td align="left">
                                                            ...
                                                            <asp:Label ID="Yellow" runat="server" BackColor="Yellow" Width="15px"></asp:Label>
                                                            <asp:Label ID="lblYellow" runat="server"></asp:Label>
                                                            <asp:Label ID="Red" runat="server" BackColor="Red" Width="15px"></asp:Label>
                                                            <asp:Label ID="lblRed" runat="server"></asp:Label>
                                                            <asp:Label ID="Label2" runat="server" BackColor="Fuchsia" Width="15px"></asp:Label>
