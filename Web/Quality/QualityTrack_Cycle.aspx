...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function getPicture(LabelPage,whoButton) {
            $.ajax({
                type: 'POST',
                url: "QualityTrack_Cycle.aspx?value1=1&LabelPage=" + LabelPage+"&whoButton="+whoButton,
                ...
                <table style="width: 100%" runat="server" id="tblChgPage">
                    <tr>
                        ...
                        <td align="left" id="tdPictureType" runat="server" style="width: 50%; height: 23px;">
                            ...
                            <asp:DropDownList ID="ddlImageIndex" runat="server" Enabled="false" />
                            <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label>
                        </td>
                        <td align="right" style="width: 50%;">
                            <asp:CheckBox ID="chkPictureType" runat="server" OnCheckedChanged="chkPictureType_CheckedChanged" Text="100啤1图" AutoPostBack="True" Visible="False" /></td>
                        <td  id="tdPictureType" runat="server" style="width: 50%; height: 23px;">
                            &nbsp;<asp:LinkButton ID="lkbShangPage" runat="server" OnClick="shangPage()" CommandName="Prior">上一页</asp:LinkButton>&nbsp;
                            <asp:LinkButton ID="lkbXiaPage" runat="server" OnClick="xiaPage()" CommandName="Next">下一页</asp:LinkButton>
                            <asp:DropDownList ID="ddlImageIndex" runat="server" Enabled="false" />
                            <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label>
                        </td>--%>
                        <td align="center">
