<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QualityTrack_InjectTime.aspx.cs" Inherits="Quality_QualityTrack_InjectTime" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function getPicture(LabelPage, whoButton) {
            $.ajax({
                type: 'POST',
                url: "QualityTrack_InjectTime.aspx?value1=1&LabelPage=" + LabelPage + "&whoButton=" + whoButton,
