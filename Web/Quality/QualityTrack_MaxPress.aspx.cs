...
public partial class Quality_QualityTrack_MaxPress : System.Web.UI.Page
{
  //  bool[] o = new bool[7] { false, false, false, false, false, false, false };
    ...
    private void BindData(int Flag)
    {
        ...
        if (dt.Rows.Count > 0 && dt != null || firstFlag == 0)
        {
           ...
           // stand_dt = new QualityTrack_BLL().selectStandShotTemp(MachineNo, MouldNo, ProductNo);
            ...
            for (int i = 0; i < lived_dt.Rows.Count; i++)
            {
                ...
                cycleMap.YData.Add(Convert.ToInt32(Convert.ToDouble(lived_dt.Rows[i]["KeepPress_Max"])));
        ...
        string[] Stand_FieldName = new string[] { "KeepPress_Max" };
        string[] Lived_FieldName = new string[] { "KeepPress_Max" };
        ...
        if (URLID == "QualityTrack")
        {
            ...
            //stand_dt = new StandDataHistory_BLL().selectGeneralField("MaxPress", MachineNo, MouldNo, ProductNo, bDate, eDate, "-100");
            lived_dt = new QualityTrack_BLL().selectUnifyField(DispatchOrder,MachineNo, MouldNo, ProductNo, bDate, eDate, TotalNum);
        }
        else
        {
            if (ActionNum == "-9")
                lived_dt = new StandDataHistory_BLL().selectGeneralField("MaxPress", MachineNo, MouldNo, ProductNo, bDate, eDate, "-9");
            else
                stand_dt = new StandDataHistory_BLL().selectGeneralField("MaxPress", MachineNo, MouldNo, ProductNo, bDate, eDate, ActionNum);
        }
      ...
      //  objDraw.ExDataFieldName = new string[] {"exPreInjectTime" };//{ "MaxPress" };
