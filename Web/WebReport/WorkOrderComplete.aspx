<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WorkOrderComplete.aspx.cs"
    Inherits="WebReport_WorkOrderComplete" %>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>派工单达成率报表</title>
 ...
 <script language="jscript" type="text/javascript">
        mainLoop = function()
        {
            ...
            if (lastVal != val)
            {
                ...
                var response = WebReport_WorkOrderComplete.GetSearhItmes(val);
                showQueryDiv(response.value);
                
                lastVal = val;
            }
           newById=WebReport_WorkOrderComplete;
        ...
        <table id="tblBiggest" border="0" cellpadding="0" cellspacing="0" class="section-content">
            <tr>
                    ...
                    <table border="0" cellpadding="1" cellspacing="1" class="texttable" style="border-collapse: collapse;
                        ...
                        <tr>
                            <th align="right" style="width: 40%">
                                <asp:Label ID="Label2" runat="server" Text="生产日期:"></asp:Label></th>
                           <td>
               ...
               <%-- <script language="javascript" type="text/javascript">window.oninit=InitQueryCode("search","querydiv");</script>--%>
                        ...
                        <tr>
                            <th align="right" style="width: 40%; height: 16px">
                                车间:</th>
