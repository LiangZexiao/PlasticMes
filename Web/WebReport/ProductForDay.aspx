<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductForDay.aspx.cs" Inherits="WebReport_ProductForDay" %>
    ...
    <script language="jscript" type="text/javascript">
        mainLoop = function()
        {
            ...
            if (lastVal != val)
            {
                ...
                var response = WebReport_ProductForDay.GetSearhItmes(val);
                showQueryDiv(response.value);
                
                lastVal = val;
            }
           newById=WebReport_ProductForDay;
