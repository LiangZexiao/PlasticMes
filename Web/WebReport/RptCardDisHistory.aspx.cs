...
public partial class WebReport_RptCardDisHistory : System.Web.UI.Page
{
    ...
    {
        Ajax.Utility.RegisterTypeForAjax(typeof(WebReport_RptCardDisHistory));
        try
        {
            ...
            o = RightCtrl.PageRightCtrl(this.Page.User.Identity.Name.Trim(), "RptCardDisHistory");
    ...
    protected void igbPrint_Click(object sender, ImageClickEventArgs e)
    {
        ...
        string ReportName = "RptCardDisHistory";
