<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptCardDisHistory.aspx.cs" Inherits="WebReport_RptCardDisHistory" %>
    ...
    <script language="jscript" type="text/javascript">
        mainLoop = function()
        {
            ...
            if (lastVal != val)
            {
                ...
                var response = WebReport_RptCardDisHistory.GetSearhItmes(val);
                showQueryDiv(response.value);
                
                lastVal = val;
            }
           newById=WebReport_RptCardDisHistory;
                        ...
                        <tr>
                         ...
                         <tr>
                            <th align="right">
                                机器编号:</th>
                            <td align="left">
                                <input id="txtMachineNo" runat="server"  name="txtMachineNo" style="width: 160px"
                                    type="text" />
                            </td>
                        </tr>
                        <tr>
