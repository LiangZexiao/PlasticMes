<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WorkShopMaterial.aspx.cs" Inherits="WebReport_WorkShopMaterial" %>



<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>车间用料情况报表</title>
 ...
 <script language="jscript" type="text/javascript">
        mainLoop = function()
        {
            ...
            if (lastVal != val)
            {
                ...
                var response = WebReport_WorkShopMaterial.GetSearhItmes(val);
                showQueryDiv(response.value);
                
                lastVal = val;
            }
           newById=WebReport_WorkShopMaterial;
...
<body>
    <form id="form1" runat="server">
          ...
          <tr>
            <td style="height: 24px">当前位置:报表管理 -> 车间用料情况统计表</td>
          </tr>
          </table>
          <br />
