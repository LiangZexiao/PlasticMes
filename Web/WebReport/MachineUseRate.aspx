<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MachineUseRate.aspx.cs" Inherits="WebReport_MachineUseRate" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>注塑机使用率报表(MachineUseRate)</title>
...
<body>
    ...
    <div>
    <asp:Label id="lblLocal" runat="server" Text="当前位置:报表管理-->注塑机使用率报表" ForeColor="Blue"></asp:Label>
    </div>
