<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateMacCycle.aspx.cs" Inherits="Product_UpdateMacCycle" %>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>机器周期修改记录(UpdateMacCycle)</title>
                            ...
                            <tr>
                                <td>
                                    <asp:DropDownList ID="ddlQuery" runat="server">
                                        <asp:ListItem Value="a.DispatchNo">派工单号</asp:ListItem>
                                        <asp:ListItem Value="a.MachineNo">机器编号</asp:ListItem>
                                        <asp:ListItem Value="a.MouldNo">模具编号</asp:ListItem>
                                    </asp:DropDownList>
                                    <asp:TextBox ID="txtQuery" runat="server" CssClass="textbox"></asp:TextBox>
                                    &nbsp;日期:<input runat="server" type="text" id="inStartDate" name="txtBeginDate" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm'})"
                                    ...
                                    <asp:ImageButton ID="igbNewadd" runat="server" ImageUrl="~/images/btn_newadd.gif"
                                        OnClick="btnVisible_Click" ImageAlign="Top" Visible="false" />
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" CellPadding="2" Width="100%" AutoGenerateColumns="False"
                                        AllowPaging="True" PageSize="12" OnRowDataBound="GridView1_RowDataBound" CssClass="itemtable"
                                        BorderWidth="0px" CellSpacing="1" OnRowCommand="GridView1_RowCommand">
...
--%>
                                            <asp:BoundField DataField="DispatchNo" HeaderText="派工单号" SortExpression="DispatchNo" />
                                            ...
                                            <asp:BoundField DataField="lastcycle" HeaderText="原机器周期 " SortExpression="lastcycle" />
                                            <asp:BoundField DataField="thiscycle" HeaderText="新机器周期" SortExpression="thiscycle" />
                                            <asp:BoundField DataField="EndDate" HeaderText="更新时间" SortExpression="EndDate" />
                                        </Columns>
                    ...
                    <asp:View ID="View2" runat="server">
                        ...
                        <table border="0" style="border-collapse: collapse;" width="100%" cellpadding="1"
                            ...
                            <tr>
                                <th align="right" class="style1">
                                    <asp:Label ID="lblDispatchNo" runat="server" Text="派工单号:" CssClass="txtlab"></asp:Label>
                                </th>
                                <td class="style2">
                                    ...
                                    <asp:CustomValidator ID="CvtxtDispatchNo" runat="server" ControlToValidate="txtDispatchNo"
                                        ErrorMessage="无此工单信息" ClientValidationFunction="GetDispatchNo" Display="Dynamic">
                                    </asp:CustomValidator>
                                </td>
                                <th align="right" class="style3">
                                    <asp:Label ID="Label1" runat="server" CssClass="txtlab" Text="产品编号:"></asp:Label>
                                </th>
                                <td class="style4">
                                ...
                                <th align="right" class="style1">
                                    <asp:Label ID="Label4" runat="server" Text="产品描述:"></asp:Label>
                                </th>
                                <td class="style5">
                            ...
                            <tr>
                                <th align="right" style="width: 9%">
                                    <asp:Label ID="Label2" runat="server" CssClass="txtlab" Text="模具编号:"></asp:Label>
                                </th>
                                <td style="width: 20%">
                                    <asp:TextBox ID="txtMouldNo" runat="server" CssClass="textboxodl" Enabled="False"></asp:TextBox>
                                </td>
                                <th align="right" style="width: 9%">
                                    <asp:Label ID="Label3" runat="server" CssClass="txtlab" Text="机器编号:"></asp:Label>
                                </th>
                                <td style="width: 15%">
                                    <asp:TextBox ID="txtMachineNo" runat="server" CssClass="textboxodl" Enabled="False"></asp:TextBox>
                                </td>
                                <th align="right" style="width: 9%">
                                    <asp:Label ID="lblProductDate" runat="server" Text="开始时间:" CssClass="txtlab"></asp:Label>
                                </th>
                                <td style="width: 30%">
                                    <input runat="server" type="text" id="txtStartDate" name="txtStartDate" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss'})"
                        ...
                        onkeypress="return false" onselectstart="return false;" type="text" visible="true"  />
                            ...
                            <tr>
                                <th align="right" style="width: 9%">
                                    <asp:Label ID="lblWorker" runat="server" Text="调机人:" CssClass="txtlab"></asp:Label>
                                </th>
                                <td style="width: 20%">
                                    <asp:DropDownList ID="ddlWorker" runat="server" CssClass="textboxodl">
                                    </asp:DropDownList>
                                ...
                                <td style="width: 20%">
                                    ...
                                    PCS<asp:RegularExpressionValidator ID="revTotalQty" runat="server" ControlToValidate="txtTotalQty"
                                        Display="Static" ErrorMessage="有误" ValidationExpression="^\d+$"></asp:RegularExpressionValidator>
                                    <asp:CustomValidator ID="CvtxtTotalQty" runat="server" ControlToValidate="txtTotalQty"
                                        ErrorMessage="不能超过派工数" ClientValidationFunction="IsExceedDispatchNum" Display="Dynamic">
                                    </asp:CustomValidator>
                                </td>
                                <th align="right" style="width: 9%">
                                ...
                                <td style="width: 30%">
                                    <input runat="server" type="text" id="txtEndDate" name="txtEndDate" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss'})"
                                        class="Wdate" style="width: 140px" />
                        ...
                        onkeypress="return false" onselectstart="return false;" type="text" visible="true"  />
                         <input id="txtEndTime" runat="server" class="textboxodl" maxlength="5" name="txtEndTime"
                                    ...
                                    ErrorMessage="必填"></asp:RequiredFieldValidator>--%>
                                    <asp:TextBox ID="txtID" runat="server" CssClass="textbox" Visible="false" Width="12px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <th align="right" style="width: 9%">
                                ...
                                <th align="right" style="width: 9%">
                                    <asp:Label ID="Label6" runat="server" Text="调机原因:" CssClass="txtlab"></asp:Label>
                                </th>
                                <td style="width: 20%">
                                    <asp:DropDownList ID="ddlStopMachine" runat="server" CssClass="textbox">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="5">
                                    <asp:TextBox ID="txtModiHistoryContent" runat="server" CssClass="textbox" Height="60px"
                                        TextMode="MultiLine" Width="99%" ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    </asp:View>
