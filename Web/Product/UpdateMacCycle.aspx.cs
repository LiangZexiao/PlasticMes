...
public partial class Product_UpdateMacCycle : System.Web.UI.Page
{
    ...
    {
        Ajax.Utility.RegisterTypeForAjax(typeof(Product_UpdateMacCycle));
        try
        {
            ...
            o = RightCtrl.PageRightCtrl(this.Page.User.Identity.Name.Trim(), "UpdateMacCycle");
    ...
    public void BindData(string sortExpression, string sortDirection)
    {
        ...
        IList<UpdateMacCycle_MDL> tempList =new UpdateMacCycle_DAL().selectUpdateMacCycle(0, colname, coltext, BeginDate, EndDate);
    ...
    protected void btnUpdate_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (IU == "INSERT")
        {
            string strSQL = @"select DispatchNo from tblUpdateMacCycle 
        ...
        if (IU == "UPDATE")
        {
            ...
            ArrayList myArrListOld = Session["UpdateMacCyclemyArrListOld"] as ArrayList;
        ...
        try
        {
            //int flages = UpdateMacCycle_BLL.ChangeUpdateMacCycle(vID, vWorkOrderNo, vDispatchNo, vTotalQty,
    ...
    protected void btnDelete_Click(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            ...
            if (tempButton.ID == "igbDelete")
            {
                ...
                //UpdateMacCycle_BLL.cancelUpdateMacCycle(pIDList);
            }
            else
            {
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        //IList<UpdateMacCycle_MDL> tempIList = UpdateMacCycle_BLL.selectUpdateMacCycle(Int32.Parse(vID), "", "", "", "");
        ...
        //Session["UpdateMacCyclemyArrListOld"] = myArrListOld;
