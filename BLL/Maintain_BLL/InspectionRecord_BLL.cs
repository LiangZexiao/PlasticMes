...
namespace Admin.BLL.Maintain_BLL
{
    public class MaintainInfo_BLL
    {
        ...
        public static IList<MaintainInfo_MDL> existsMaintainInfo(string vRepareDate, string vDeviceNo)
        {
            return factory.existsMaintainInfo(vRepareDate, vDeviceNo);
        }
        ...
        public static int DeleteMainInfo(string types)
        {
            return factory.DeleteMainInfo(types);
        }
