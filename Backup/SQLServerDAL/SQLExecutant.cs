...
{
   public class SQLExecutant
   {
       public static readonly string CntStrLocal = SqlHelper.CntStringOfdb;//连接服务器
       ...
       SqlConnection objConnection = new SqlConnection(SqlHelper.CntStringOfdb);//CntStrLocal);
